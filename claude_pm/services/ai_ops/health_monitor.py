...
class HealthMonitor:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.component_categories = {
            ...
            "services": ["ai_service_manager", "cost_manager", "tools_manager", "security_framework"],
    ...
    async def _cleanup_old_data(self):
        ...
        metrics_to_remove = [
            metric_name for metric_name, metric in self.metrics.items()
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        return {
            "healthy": self.component_health.get("overall", HealthStatus.UNKNOWN) in [HealthStatus.HEALTHY, HealthStatus.DEGRADED],
            "monitoring_active": self.is_monitoring,
            "total_components": len(self.component_health),
            "active_alerts": len([a for a in self.alerts.values() if not a.resolved])
        }

...
class ToolsManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.allowed_file_extensions = self.config.get("allowed_file_extensions", [".txt", ".json", ".csv"])
        ...
        try:
            ...
            async with self.execution_semaphore:
                ...
                try:
                    ...
                    self.logger.info(f"Tool executed successfully: {tool_name} ({execution_time:.2f}s)")
        ...
        with tempfile.TemporaryDirectory() as sandbox_dir:
            ...
            try:
                result = await asyncio.wait_for(
                    tool.function(parameters, context, sandbox_env),
                    timeout=tool.timeout
                )
                return result
            except asyncio.TimeoutError:
    ...
    async def _read_file(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None, env: Optional[Dict[str, str]] = None) -> str:
        """Read file content."""
    ...
    async def _write_file(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None, env: Optional[Dict[str, str]] = None) -> str:
        """Write file content."""
        file_path = parameters["file_path"]
    ...
    async def _execute_command(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None, env: Optional[Dict[str, str]] = None) -> str:
    ...
    async def _process_json(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None, env: Optional[Dict[str, str]] = None) -> Any:
        """Process JSON data."""
    ...
    async def _http_request(self, parameters: Dict[str, Any], context: Optional[Dict[str, Any]] = None, env: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        """Make HTTP request."""
        import httpx
    ...
    async def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "registered_tools": len(self.tools),
            "enabled_tools": len([t for t in self.tools.values() if t.enabled]),
            "concurrent_executions": self.max_concurrent_executions - self.execution_semaphore._value,

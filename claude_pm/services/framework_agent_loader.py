...
1. Framework .claude-pm (next to framework/CLAUDE.md): system, trained, user agents
...
class FrameworkAgentLoader:
    ...
    def initialize(self, framework_claude_md_path: Optional[str] = None):
        ...
        Args:
            framework_claude_md_path: Optional explicit path to framework/CLAUDE.md
        """
    ...
    def _find_framework_directory(self) -> Optional[Path]:
        ...
        for path in [current] + list(current.parents):
            framework_claude_md = path / "framework" / "CLAUDE.md"

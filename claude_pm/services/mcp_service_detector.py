...
class MCPServiceDetector:
    ...
    def get_workflow_recommendations(self, workflow_name: str) -> List[Dict[str, Any]]:
        ...
        relevant_integrations = [
            wi for wi in self.workflow_integrations 
            if wi.workflow_name == workflow_name
        ]
    ...
    def generate_orchestrator_guidance(self) -> Dict[str, Any]:
        ...
        for integration in self.workflow_integrations:
            applicable_services = [
                s for s in integration.applicable_services 
...
async def get_mcp_service_recommendations(workflow: str = None, context: str = None) -> Dict[str, Any]:
    """

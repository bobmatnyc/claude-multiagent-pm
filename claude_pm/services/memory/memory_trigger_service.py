...
class MemoryTriggerService:
    ...
    def _initialize_components(self):
        ...
        try:
            ...
            self.trigger_orchestrator = MemoryTriggerOrchestrator(
                self.memory_service, orchestrator_config
            )

            # Initialize framework hooks
            hooks_config = self.config.get("hooks", {})
            self.framework_hooks = FrameworkMemoryHooks(
                self.memory_service, self.trigger_orchestrator, self.policy_engine, hooks_config
            )
    ...
    async def get_service_health(self) -> Dict[str, Any]:
        ...
        if self.memory_service:
            try:
                ...
                health["memory_service"] = {"status": "error", "error": str(e)}
        else:
        ...
        if self.trigger_orchestrator:
            try:
                ...
                health["trigger_orchestrator"] = {"status": "error", "error": str(e)}
        else:
        ...
        if self.policy_engine:
            try:
                ...
                health["policy_engine"] = {"status": "error", "error": str(e)}
        else:
        ...
        if self.framework_hooks:
            try:
                ...
                health["framework_hooks"] = {"status": "error", "error": str(e)}
        else:
    ...
    def __repr__(self) -> str:
        ...
        return f"MemoryTriggerService(initialized={self._initialized}, " f"enabled={self._enabled})"
...
DEFAULT_CONFIG = {
    ...
    "policies": {"enabled": True, "default_decision": "allow", "rate_limiting": True},
    "hooks": {
        "enabled": True,
...
async def initialize_global_memory_trigger_service(

...
class BackendNotAvailableError(MemoryServiceError):
    ...
    def __init__(
        self, message: str = "No memory backend available", attempted_backends: list = None
    ):
...
class StorageFullError(MemoryServiceError):
    ...
    def __init__(
        self, message: str, backend_name: str = None, used_space: int = None, max_space: int = None
    ):

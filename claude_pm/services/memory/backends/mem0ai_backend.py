...
class Mem0AIBackend(MemoryBackend):
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if attempt < self.max_retries - 1:
                    ...
                    self.logger.error(
                        f"mem0AI request failed after {self.max_retries} attempts: {e}"
                    )
    ...
    async def update_memory(
        ...
        try:
            update_data = {"id": memory_id, "space_name": project_name}
    ...
    async def get_project_memories(
        ...
        try:
            params = {"space_name": project_name, "limit": limit}
            ...
            raise BackendError(
                f"Failed to get project memories: {e}", "mem0ai", "get_project_memories", e
            )
    ...
    async def get_memory_stats(self, project_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"total": 0, "categories": {}, "error": str(e), "backend": "mem0ai"}
    ...
    async def bulk_add_memories(
        ...
        try:
            # Prepare batch data
            batch_data = {"space_name": project_name, "memories": []}
    ...
    async def create_memory_space(self, project_name: str, description: str = "") -> bool:
        ...
        try:
            data = {
                ...
                "metadata": {"framework": "claude-pm", "created_at": datetime.now().isoformat()},
            }

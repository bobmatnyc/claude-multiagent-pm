...
class FrameworkMemoryHooks:
    ...
    def _create_trigger_event(
        self, hook_type: str, context: HookContext, **kwargs
    ...
    def _generate_tags(self, hook_type: str, context: HookContext, **kwargs) -> List[str]:
        ...
        tags = [hook_type, context.source, context.operation_name]
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        return {
            **self.metrics,
            ...
            "registered_hooks": {
                hook_type: len(callbacks) for hook_type, callbacks in self._hook_registry.items()
            },
    ...
    def get_hook_registry(self) -> Dict[str, int]:
        ...
        return {hook_type: len(callbacks) for hook_type, callbacks in self._hook_registry.items()}

        ...
        try:
            ...
            if memories:
                ...
                if success_rate < 0.8:
                    ...
                    recommendations.append(f"Handoff success rate is {success_rate:.1%} - review handoff process")
                ...
                if durations:
                    ...
                    if avg_duration > 60:  # More than 1 minute
                        ...
                        recommendations.append(f"Average handoff duration is {avg_duration:.1f}s - consider optimization")
    ...
    async def _create_handoff_memory(self, handoff: AgentHandoffContext, phase: str):
        ...
        try:
            ...
            if phase == "initiation":
                ...
                duration = handoff.completion_time - handoff.start_time if handoff.completion_time else 0
...
class WorkflowMemoryTracker:
    ...
    async def add_workflow_handoff(
        self,
        workflow_id: str,
        handoff_context: AgentHandoffContext
    ) -> bool:
        """
    ...
    async def _create_workflow_memory(self, workflow: WorkflowMemoryState, phase: str):
        ...
        try:
            ...
            if phase == "start":
                ...
                duration = workflow.completion_time - workflow.start_time if workflow.completion_time else 0
...
class ThreeCommandMemoryIntegration:
    ...
    async def start_command_workflow(
        ...
        memory_content = f"Started {command} command for {project_name}. Agents: {', '.join(agents_involved)}"
    ...
    async def create_command_completion_memory(
        ...
        trigger_event = TriggerEvent(
            ...
            content=memory_content,
            category=MemoryCategory.WORKFLOW,
            tags=["three_command", command, "workflow_completion", "success" if success else "failure"],
            metadata=metadata,
            source="three_command_system",
            context=context
        )

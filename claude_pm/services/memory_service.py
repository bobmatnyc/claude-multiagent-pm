...
class ClaudePMMemory:
    ...
    async def search_memories(
        ...
        try:
            ...
            async with self._session.get(f"{self.base_url}/memories/search", params=search_params) as response:
    ...
    def _invalidate_cache(self, project_name: str) -> None:
        ...
        keys_to_remove = [key for key in self._memory_cache.keys() if key.startswith(f"{project_name}:")]

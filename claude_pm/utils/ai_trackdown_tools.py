...
class AITrackdownTools:
    ...
    def create_issue(
        self, title: str, epic_id: Optional[str] = None, description: str = ""
    ) -> Optional[str]:
        """
        Create a new issue.
    ...
    def create_task(
        self, title: str, issue_id: Optional[str] = None, description: str = ""
    ) -> Optional[str]:
        """
        Create a new task.
    ...
    def list_items(
        self, item_type: str, status: Optional[str] = None
...
def create_persistent_issue(
    title: str, description: str = "", epic_id: Optional[str] = None
) -> Optional[str]:
    """

...
class MCPContextBridge:
    ...
    async def get_agent_context(self, agent_type: str, project_name: str, 
    ...
    async def get_code_review_context(self, project_name: str, 
                                    files_changed: List[str], **kwargs) -> Dict[str, Any]:
        """
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.memory:
                ...
                health_data["checks"]["memory"] = {"status": "unhealthy", "error": "No memory instance"}
            ...
            if self.context_manager:
                ...
                health_data["checks"]["context_manager"] = {"status": "unhealthy", "error": "No context manager"}
                health_data["status"] = "unhealthy"
...
async def prepare_agent_context(agent_type: str, project_name: str, 
                              task_description: str, **kwargs) -> Dict[str, Any]:
    """
...
async def prepare_code_review_context(project_name: str, 
                                     files_changed: List[str], **kwargs) -> Dict[str, Any]:
    """

        ...
        try:
            ...
            if service:
                try:
                    ...
                    self.logger.warning(f"Error cleaning up temporary service {service_class.__name__}: {e}")
            ...
            if cleanup_tasks:
                ...
                for i, result in enumerate(results):
                    if isinstance(result, Exception):
                        service_name = list(self._services.keys())[i] if i < len(self._services) else f"service_{i}"

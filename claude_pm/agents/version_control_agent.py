...
class PMIntegrationInterface:
    ...
    async def report_conflict_analysis(
        self, 
...
class VersionControlAgent(BaseAgent):
        ...
        try:
            ...
            if project_root:
                ...
                await self.collaborate_with_pm(
                    ...
                    context={
                        "project_root": self.current_project_root,
                        "current_branch": self.current_branch_info.name if self.current_branch_info else None,
    ...
    async def merge_branch(
        ...
        try:
            ...
            await self.pm_integration.notify_merge_completion(
                source_branch, target_branch, result
            )
    ...
    async def delete_branch(self, branch_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self.git_manager._run_git_command(
                ["branch", "-d", branch_name], check=False
            )
            ...
            if success:
                ...
                return {
                    "success": False,
                    "error": result.stderr or "Failed to delete branch"
                }
    ...
    async def bump_version(
        ...
        try:
            ...
            if not current_version:
                return {
                    "success": False,
                    "error": "No current version found in project files"
                }
    ...
    async def set_branch_strategy(self, strategy_type: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "message": f"Branch strategy set to {strategy_type}" if success else "Failed to set strategy"
            }
    ...
    def _should_notify_pm(self, operation: str, result: Any) -> bool:
        ...
        major_operations = [
            ...
            "bump_version", "create_release", "resolve_conflicts"
        ]

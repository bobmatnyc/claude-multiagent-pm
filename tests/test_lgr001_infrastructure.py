...
from claude_pm.services.multi_agent_orchestrator import (
    MultiAgentOrchestrator, AgentType, AgentStatus, AgentExecution, AgentTask
)
from claude_pm.services.intelligent_task_planner import (
    IntelligentTaskPlanner, TaskComplexity, DecompositionStrategy, TaskDecomposition
)
...
class TestTaskDelegationInfrastructure:
    ...
    def test_acceptance_2_base_service_classes(self):
        ...
        try:
            ...
            memory = ClaudePMMemory()
            orchestrator = MultiAgentOrchestrator(base_repo_path=str(self.test_repo_path), memory=memory)
    ...
    async def test_acceptance_5_basic_task_orchestration(self):
        ...
        try:
            ...
            assert result.status in [AgentStatus.COMPLETED, AgentStatus.EXECUTING, AgentStatus.FAILED]
    ...
    async def test_performance_benchmarks(self):
        ...
        try:
            ...
            assert decomposition_time < 5.0, f"Task decomposition too slow: {decomposition_time:.3f}s"

...
class TestCLIBackupCommands:
    ...
    @pytest.mark.unit
    def test_backup_command_success(self, temp_project_dir, sample_claude_md_basic, mock_nodejs_environment):
...
class TestCLISetupCommands:
    ...
    @pytest.mark.unit
    def test_setup_command_existing_project(self, temp_project_dir, sample_claude_md_basic, mock_nodejs_environment):
    ...
    def multi_project_structure(self, temp_project_dir):
        ...
        for project in projects:
            ...
            if project == "project1":
                ...
                claude_file.write_text("# PM Framework Project\nYou are a Claude PM Framework Orchestrator.")
            else:
...
"""
    ...
    @pytest.mark.unit
    def test_analyze_command_risk_detection(self, temp_project_dir, sample_claude_md_conflicted, mock_nodejs_environment):
...
"""
    ...
    @pytest.mark.unit
    def test_analyze_command_compatibility_check(self, temp_project_dir, sample_claude_md_with_pm, mock_nodejs_environment):
...
class TestCLIIntegrationScenarios:
    ...
    def test_complete_backup_setup_workflow(self, temp_project_dir, sample_claude_md_basic, mock_nodejs_environment):
    ...
    @pytest.mark.integration
    def test_setup_restore_workflow(self, temp_project_dir, sample_claude_md_basic, mock_nodejs_environment):

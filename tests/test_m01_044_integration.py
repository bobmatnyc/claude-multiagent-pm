...
async def test_health_dashboard():
    ...
    try:
        ...
        try:
            ...
            print(f"   Health Percentage: {dashboard.current_report.overall_health_percentage:.1f}%")
        except Exception as e:
        ...
        try:
            ...
            if health_cmd:
                ...
                # Check options
                options = [param.name for param in health_cmd.params if isinstance(param, click.Option)]

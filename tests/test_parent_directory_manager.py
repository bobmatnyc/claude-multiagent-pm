...
class TestParentDirectoryManager:
    ...
    async def parent_directory_manager(self, temp_dir):
        ...
        manager.parent_directory_manager_dir = working_dir / ".claude-pm" / "parent_directory_manager"
    ...
    @pytest.mark.asyncio
    async def test_install_template_without_template_manager(self, parent_directory_manager, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_integration_with_template_manager(self, parent_directory_manager, temp_dir, mock_template_manager):
        ...
        mock_template_manager.render_template.return_value = "# Test Project Configuration\nProject description"
    ...
    @pytest.mark.asyncio
    async def test_integration_with_dependency_manager(self, parent_directory_manager, mock_dependency_manager):

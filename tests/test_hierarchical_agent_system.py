...
from claude_pm.agents.hierarchical_agent_loader import HierarchicalAgentLoader, AgentInfo, AgentHierarchy
...
'''
    ...
    async def test_agent_discovery_hierarchy(self, temp_directories):
        ...
        self.create_test_agent(dirs["project_agents_dir"], "project_engineer", "engineer", "project")
    ...
    async def test_agent_hierarchy_validation(self, temp_directories):
        ...
        self.create_test_agent(dirs["project_agents_dir"], "project_security", "security", "project")
...
async def test_end_to_end_agent_workflow(temp_directories):
    ...
    test_case.create_test_agent(dirs["system_agents_dir"], "system_integration", "integration", "system")
    test_case.create_test_agent(dirs["user_agents_dir"], "user_integration", "integration", "user")
    test_case.create_test_agent(dirs["project_agents_dir"], "project_integration", "integration", "project")

    ...
    async setupMemorySystem() {
        try {
            ...
            for (const dir of memoryDirs) {
                ...
                this.log(`   ✅ Created memory directory: ${path.basename(dir)}`);
            }
            ...
            this.installationSteps.push('MemorySystemSetup');
...
`;
    ...
    async initializeFramework() {
        try {
            ...
            this.installationSteps.push('FrameworkInitialization');
...
`;
    ...
    async run() {
        ...
        try {
            ...
            // Phase 2.5: Memory System Setup (NEW - Critical for user feedback)
            await this.safeExecute('setupMemorySystem', () => this.setupMemorySystem());
            
            // Phase 2.6: Framework Initialization (NEW - cmcp-init equivalent)
            await this.safeExecute('initializeFramework', () => this.initializeFramework());

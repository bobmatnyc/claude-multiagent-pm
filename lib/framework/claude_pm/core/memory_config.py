    ...
    def _initialize_default_configs(self):
        ...
        self.configs["development"] = MemoryEnvironmentConfig(
            ...
            memory_config=ClaudePMConfig(
                ...
                timeout=int(os.getenv("CLAUDE_PM_MEMORY_TIMEOUT", "10")),
                max_retries=2,
                retry_delay=0.5,
        ...
        self.configs["testing"] = MemoryEnvironmentConfig(
            ...
            memory_config=ClaudePMConfig(
                host=os.getenv("CLAUDE_PM_MEMORY_TEST_HOST", "localhost"),
                port=int(os.getenv("CLAUDE_PM_MEMORY_TEST_PORT", "8002")),
                timeout=5,
                max_retries=1,
                retry_delay=0.1,
        ...
        self.configs["staging"] = MemoryEnvironmentConfig(
            ...
            memory_config=ClaudePMConfig(
                host=os.getenv("CLAUDE_PM_MEMORY_STAGING_HOST", "memory-staging.internal"),
                port=int(os.getenv("CLAUDE_PM_MEMORY_STAGING_PORT", "8002")),
                timeout=20,
                max_retries=3,
                retry_delay=1.0,
                connection_pool_size=15,
                enable_logging=True,
                api_key=os.getenv("CLAUDE_PM_MEMORY_STAGING_API_KEY"),
                batch_size=100,
        ...
        self.configs["production"] = MemoryEnvironmentConfig(
            ...
            memory_config=ClaudePMConfig(
                host=os.getenv("CLAUDE_PM_MEMORY_PROD_HOST", "memory-service.internal"),
                port=int(os.getenv("CLAUDE_PM_MEMORY_PROD_PORT", "8002")),
                timeout=30,
                max_retries=3,
                retry_delay=1.0,
                connection_pool_size=50,
                enable_logging=True,
                api_key=os.getenv("CLAUDE_PM_MEMORY_PROD_API_KEY"),
                batch_size=200,
